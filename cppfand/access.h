...
struct FieldDescr : public Chained // ш. 100
{
...
struct KeyFldD : public Chained // ш. 108
{
...
struct ChkD : public Chained // ш. 115
{
	// ChkD* Chain = nullptr;
	FrmlPtr Bool;
...
struct LocVarBlkD : public Chained// ш. 228
{
	LocVar* Root;
	WORD NParam, Size;
};
...
struct LocVar : public Chained // ш. 239
{
	bool IsPar;
	char FTyp;
	FileD* FD;
